    ...
    <FlatList
        ...
        renderItem={({ item }) => (
          ...
          <View style={{padding:10,}}>
            ...
            <Button rippleColor="#FF000020" style={styles.apply} mode='contained' onPress={()=>props.navigation.navigate("Desc1",{jobName:item.cname,jobRole:item.JobRole,jobDes:item.JobDes,jobType:item.JobType,jobLoc:item.Location,jobPos:item.Position,jobSal:item.Salary,jobId:item.id},)}>Check Details</Button>
            </View>
            </Card>
        )}
        />
